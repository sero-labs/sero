...
## [0.9.0-beta.0](https://github.com/sero-labs/sero/compare/v0.8.0-beta.0...v0.9.0-beta.0) (2026-09-26)

### Features

* act on it (issue [#537](https://github.com/sero-labs/sero/issues/537)) ([#549](https://github.com/sero-labs/sero/issues/549)) ([90ee3c3](https://github.com/sero-labs/sero/commit/90ee3c3e765f9a1c6ed7a7ba6570f0ac26dbcc4f))
* **activity:** one activity vocabulary across Architect, Orchestrator and the tree ([#544](https://github.com/sero-labs/sero/issues/544)) ([19e69ad](https://github.com/sero-labs/sero/commit/19e69adff842b0ea6f1efc2a1732266f12f6e888)), closes [537-#543](https://github.com/sero-labs/537-/issues/543)
* add provider model settings contributions ([#471](https://github.com/sero-labs/sero/issues/471)) ([8d46c71](https://github.com/sero-labs/sero/commit/8d46c71b5114a3e068152cecf4addee1c5f87365))
* add skill for me pruning guidelines for test audits ([3ec0fc9](https://github.com/sero-labs/sero/commit/3ec0fc9f7d80248c1eef94edf84c5a6e92a20466))
* add SKILL.md for pruning tests guidelinesa ([1485a3f](https://github.com/sero-labs/sero/commit/1485a3fb41f42b8bed3510393ab23194efb1cf97))
* **agent:** add programmatic tool calling ([#492](https://github.com/sero-labs/sero/issues/492)) ([3be1223](https://github.com/sero-labs/sero/commit/3be1223cbce88661ae8cd3ce963e84b4555634ad))
* architect run observability phase 1 ([37784e4](https://github.com/sero-labs/sero/commit/37784e452fc8820d44b1e9d2768fd151eeab9034))
* **architect:** add project model default actions to the plugin action path ([272deda](https://github.com/sero-labs/sero/commit/272deda607ce0ed35c43f4f76f224698191dc4bb))
* **architect:** add semantic operation spans with a full-run fixture ([409da98](https://github.com/sero-labs/sero/commit/409da9839ea96674b1a75b39c1bbb67da17ac1a4))
* **architect:** apply project model defaults to the owner's next turn ([bbb75ba](https://github.com/sero-labs/sero/commit/bbb75ba610777aa2b1ccdb922f5ce252361a9027))
* **architect:** build the run inspector ([6f9c756](https://github.com/sero-labs/sero/commit/6f9c756ef905c30d4965ae1f7400ea66a2b8267c))
* **architect:** chart what the runtime actually reported ([e1bceea](https://github.com/sero-labs/sero/commit/e1bceea034f58ca1f6c6ff06b5f88b00086dadc1))
* **architect:** connect the project model defaults view to the menu ([9508cda](https://github.com/sero-labs/sero/commit/9508cda85bd7fd06ed6ee8d17deca433b1c45818))
* **architect:** correlate Orchestrator planning and Room creation spans ([42cfc24](https://github.com/sero-labs/sero/commit/42cfc24ae276819824f2bf8ae2d8fe4d3131617e))
* **architect:** decide relevance from the record, not from a name ([ce7f87d](https://github.com/sero-labs/sero/commit/ce7f87d392bd6f39f1057c3a9bd0a53ac18cc8d9))
* **architect:** do not ask a model what the caller already said ([8bc6d2f](https://github.com/sero-labs/sero/commit/8bc6d2f654fcec39f9b41fee1e452736c8683fbc))
* **architect:** guide the owner by the work, not by a sequence ([707fa4a](https://github.com/sero-labs/sero/commit/707fa4a06d79a70daab10f57fe82cf01c919bc0e))
* **architect:** let research Rooms run commands when the question needs it ([ff37d31](https://github.com/sero-labs/sero/commit/ff37d313fd16ff3cf2531546d30465f033a6b064))
* **architect:** name the model an operation actually used ([504e140](https://github.com/sero-labs/sero/commit/504e14076604acb50f5316c65061210db223e828))
* **architect:** name what the inspector is looking at ([6c21534](https://github.com/sero-labs/sero/commit/6c215345e093ea502e03396975451ebc12183657))
* **architect:** read a trace without letting it out of the runtime ([d5aed0c](https://github.com/sero-labs/sero/commit/d5aed0c8cc456a65d345e0c1da624c33ec60effd))
* **architect:** record observed waits without inventing time ([9053ae2](https://github.com/sero-labs/sero/commit/9053ae27175e516ac1ed93774aafe9d0138bc26c))
* **architect:** redesign the Run inspector to the approved prototype ([#561](https://github.com/sero-labs/sero/issues/561)) ([426fdbc](https://github.com/sero-labs/sero/commit/426fdbc38e5137aac982c573ba73e9da85962058)), closes [#535](https://github.com/sero-labs/sero/issues/535) [#535](https://github.com/sero-labs/sero/issues/535)
* **architect:** reference research reports instead of repeating them ([99f0b81](https://github.com/sero-labs/sero/commit/99f0b81ae441609d16409f1c2e62c8e514da54c2))
* **architect:** resolve project model tiers and carry the snapshot to dispatch ([13267d6](https://github.com/sero-labs/sero/commit/13267d65253d8e0a0078a9930894f2c9f98ceee5))
* **architect:** run identity, project model overrides and run journals ([3f63ecf](https://github.com/sero-labs/sero/commit/3f63ecffe38c133ab185ad039a72a9b583ea8a87))
* **architect:** say who is allowed to be an independent check ([c27462f](https://github.com/sero-labs/sero/commit/c27462fafd4db9af7b43260b2e2a3e1ff931815b))
* **architect:** span the evidence and capture operations ([773b33d](https://github.com/sero-labs/sero/commit/773b33db99fffef5478e5f8301f18e75a29b21a3))
* **architect:** start a project in an existing workspace ([#557](https://github.com/sero-labs/sero/issues/557)) ([42ec0a8](https://github.com/sero-labs/sero/commit/42ec0a898011969fd575f3b23745ddbb382e3d53)), closes [#542](https://github.com/sero-labs/sero/issues/542) [#542](https://github.com/sero-labs/sero/issues/542)
* **architect:** summarize run cost, timing, tokens and legacy coverage ([005cbba](https://github.com/sero-labs/sero/commit/005cbba097188fe5c504d1bf9d656c49d119e4f5))
* **common:** add metadata-only run observation contracts ([1d46162](https://github.com/sero-labs/sero/commit/1d4616294bf4872c60aaf3ec7ea6caa922f2a02d))
* **desktop:** add browser pack update controls ([#467](https://github.com/sero-labs/sero/issues/467)) ([0053144](https://github.com/sero-labs/sero/commit/00531448abaaba8ef71931944f4dc8bd751928b3))
* **desktop:** add the output optimizer plugin ([#525](https://github.com/sero-labs/sero/issues/525)) ([383efb0](https://github.com/sero-labs/sero/commit/383efb07bcfb11e354360b9f40be23e69c88aa77))
* **desktop:** observe persistent-session turns with identities and timing ([c32d65a](https://github.com/sero-labs/sero/commit/c32d65a501e5286f4df29fbd16dda1beb3d794be))
* **desktop:** observe subagent execution end to end ([a00724f](https://github.com/sero-labs/sero/commit/a00724f1b2a15921a769bbdc6c712abff5d2fb91))
* **desktop:** pin RTK and capture complete bash output ([#524](https://github.com/sero-labs/sero/issues/524)) ([07adc96](https://github.com/sero-labs/sero/commit/07adc9660e136f6561e26a0acdc443890a542c85))
* **desktop:** refresh the model catalog without a pi release ([#521](https://github.com/sero-labs/sero/issues/521)) ([443805f](https://github.com/sero-labs/sero/commit/443805fbc6179a6d1c55ef878c5f28beaa60498b)), closes [#517](https://github.com/sero-labs/sero/issues/517) [#517](https://github.com/sero-labs/sero/issues/517)
* **desktop:** restore multi-hunk file editing and safe same-file mutations ([#523](https://github.com/sero-labs/sero/issues/523)) ([092d08f](https://github.com/sero-labs/sero/commit/092d08f62cbbf33095b31e1d0b154c76fbe32f11))
* **desktop:** window, virtualize, and batch long chat threads ([#501](https://github.com/sero-labs/sero/issues/501)) ([457b1af](https://github.com/sero-labs/sero/commit/457b1af4f85ca7d19ee4c77581a9dd9da7765935)), closes [#472](https://github.com/sero-labs/sero/issues/472)
* **mcp:** support MCP 2026-07-28 with Apps, Tasks and Skills ([#563](https://github.com/sero-labs/sero/issues/563)) ([9a73d6f](https://github.com/sero-labs/sero/commit/9a73d6f03a6796497861eca5a4aa024915decc87)), closes [#359](https://github.com/sero-labs/sero/issues/359)
* **navigation:** return one Back to where the user came from ([#554](https://github.com/sero-labs/sero/issues/554)) ([49a304f](https://github.com/sero-labs/sero/commit/49a304fd73bcec4f5e193f28b4f1872396c89292)), closes [#541](https://github.com/sero-labs/sero/issues/541) [#541](https://github.com/sero-labs/sero/issues/541)
* **orchestrator:** add delete control for finished Rooms ([#529](https://github.com/sero-labs/sero/issues/529)) ([3574024](https://github.com/sero-labs/sero/commit/3574024954548c3d54688165326c740634198eb3))
* **orchestrator:** Goal mode ([#469](https://github.com/sero-labs/sero/issues/469)) ([74ea58b](https://github.com/sero-labs/sero/commit/74ea58b98f4a7def2ca86b0f19868c71077d3b78)), closes [#409](https://github.com/sero-labs/sero/issues/409)
* **profile:** recover profiles that exist on disk and guard the real root ([#562](https://github.com/sero-labs/sero/issues/562)) ([9895532](https://github.com/sero-labs/sero/commit/9895532660f319eb1826c74079ed04629e506254)), closes [#547](https://github.com/sero-labs/sero/issues/547) [#548](https://github.com/sero-labs/sero/issues/548)
* Sero Architect ([#507](https://github.com/sero-labs/sero/issues/507)) ([165b30a](https://github.com/sero-labs/sero/commit/165b30a56742f76c8ebfd9da0260c4e09161c463))
* **theme:** add desktop glass background ([#503](https://github.com/sero-labs/sero/issues/503)) ([6fc8ab3](https://github.com/sero-labs/sero/commit/6fc8ab3e95d22cdf98fd0ff87eddaaa0dfc3ae4e))
* **ux:** history and comparison ([#552](https://github.com/sero-labs/sero/issues/552)) ([0e0863e](https://github.com/sero-labs/sero/commit/0e0863eb89212a022becaa68f3d822de0209a9d6)), closes [#539](https://github.com/sero-labs/sero/issues/539)
* **ux:** one searchable model picker everywhere ([#543](https://github.com/sero-labs/sero/issues/543)) ([#558](https://github.com/sero-labs/sero/issues/558)) ([8fbed50](https://github.com/sero-labs/sero/commit/8fbed50f793e8bb61c5bfe614b53f53668ca1533))
* **ux:** read the outcome (issue [#538](https://github.com/sero-labs/sero/issues/538)) ([#550](https://github.com/sero-labs/sero/issues/550)) ([7a52f9e](https://github.com/sero-labs/sero/commit/7a52f9ef0d760d2997e2d15eac26eab92f12f407)), closes [#537](https://github.com/sero-labs/sero/issues/537)
* **ux:** start something (issue [#540](https://github.com/sero-labs/sero/issues/540)) ([#553](https://github.com/sero-labs/sero/issues/553)) ([ff66f6a](https://github.com/sero-labs/sero/commit/ff66f6aed53b2bf079f9853c72b338cd8c759a6a))
* **web-remote:** board, notifications, git, uploads, widgets, PWA and push ([#500](https://github.com/sero-labs/sero/issues/500)) ([d388424](https://github.com/sero-labs/sero/commit/d3884242bb8074cb8c7926d0957c5935dcd9d87d)), closes [#494](https://github.com/sero-labs/sero/issues/494) [#493](https://github.com/sero-labs/sero/issues/493) [#255](https://github.com/sero-labs/sero/issues/255) [#261](https://github.com/sero-labs/sero/issues/261) [#253](https://github.com/sero-labs/sero/issues/253) [#493](https://github.com/sero-labs/sero/issues/493) [#254](https://github.com/sero-labs/sero/issues/254) [#495](https://github.com/sero-labs/sero/issues/495) [#495](https://github.com/sero-labs/sero/issues/495) [#496](https://github.com/sero-labs/sero/issues/496) [#258](https://github.com/sero-labs/sero/issues/258) [#257](https://github.com/sero-labs/sero/issues/257) [#258](https://github.com/sero-labs/sero/issues/258) [#254](https://github.com/sero-labs/sero/issues/254) [#259](https://github.com/sero-labs/sero/issues/259) [#499](https://github.com/sero-labs/sero/issues/499) [#260](https://github.com/sero-labs/sero/issues/260) [#256](https://github.com/sero-labs/sero/issues/256) [#498](https://github.com/sero-labs/sero/issues/498) [#262](https://github.com/sero-labs/sero/issues/262)

### Bug Fixes

* **architect:** answer review round 1 across runtime, orchestrator and inspector ([1eafa08](https://github.com/sero-labs/sero/commit/1eafa0887653d522346422e9f2a9b2f2634877b5))
* **architect:** answer review round 1 on research access ([98e115f](https://github.com/sero-labs/sero/commit/98e115fc8c2dd4b4c9512f120c82e010e3c4d32c))
* **architect:** answer review round 2 ([eb73d42](https://github.com/sero-labs/sero/commit/eb73d4258a0f1aa0688aaae4a5aaba039a71e30b))
* **architect:** answer review round 3 ([43ba78e](https://github.com/sero-labs/sero/commit/43ba78e811c336e674ba31af049b5ca58b13ed98))
* **architect:** answer the inspector's accessibility and identity findings ([a084687](https://github.com/sero-labs/sero/commit/a084687eadb9d1ccdc9c714e0c6d506dbaee10b8))
* **architect:** end an owner turn that a stop interrupts while it opens ([8cab8cb](https://github.com/sero-labs/sero/commit/8cab8cbbe1f661ecdf04bedaf74068a08edf692b))
* **architect:** journal the charges the budget already records ([700952f](https://github.com/sero-labs/sero/commit/700952f3d379775d20e20418c79528b86f9996a5))
* **architect:** keep the spend line to the spend ([f5d61e5](https://github.com/sero-labs/sero/commit/f5d61e5858fa6f8a08845ef306bf68bfeba5edf5))
* **architect:** preserve project models, context and run accounting ([14d0cb2](https://github.com/sero-labs/sero/commit/14d0cb2164f5f7e6b3fa4e47752be4cf64151366))
* **architect:** put delegated spend in the trace, not only the budget ([562a038](https://github.com/sero-labs/sero/commit/562a0389f006bf71b8bbe66583599c3776a9474a))
* **architect:** restore CI and clear removed maintenance schedules ([e40f368](https://github.com/sero-labs/sero/commit/e40f368e92bc002a6708aad21241f627539eba57))
* **architect:** say when a run has no trace instead of showing zeros ([999a0cd](https://github.com/sero-labs/sero/commit/999a0cd13b69ff589501f5cd71fc876b050b086b))
* **architect:** show the maintenance subscription as watching, not running ([2c278e8](https://github.com/sero-labs/sero/commit/2c278e8a5a5ac5e1c9a57b459594acef38adb87b))
* **ci:** repair failing E2E and release checks ([#569](https://github.com/sero-labs/sero/issues/569)) ([33f5868](https://github.com/sero-labs/sero/commit/33f58680c33b503d186625b574246a9a2708ab16)), closes [#562](https://github.com/sero-labs/sero/issues/562) [#568](https://github.com/sero-labs/sero/issues/568)
* **design-library:** load background runtime ([#505](https://github.com/sero-labs/sero/issues/505)) ([a53a2ba](https://github.com/sero-labs/sero/commit/a53a2ba053d9f277ae91967e3fe5ca6a69f7fe8e))
* **desktop:** keep long approval messages inside the window ([c667cc3](https://github.com/sero-labs/sero/commit/c667cc393ba0fe9a3758d2a500ca530e51a6f3ac))
* **desktop:** log container cleanup failures once per cause ([af92f63](https://github.com/sero-labs/sero/commit/af92f63c0c8a77fa3822245d345a8943475daa13))
* **desktop:** recover orphaned host dev servers ([#565](https://github.com/sero-labs/sero/issues/565)) ([d839eee](https://github.com/sero-labs/sero/commit/d839eeea4467960108be2b79d176a38fd5b17621))
* **desktop:** stop logging gh reads for workspaces without GitHub ([2be2c49](https://github.com/sero-labs/sero/commit/2be2c494e88660578bdb94d5039fe7b0e163bf22))
* **desktop:** stop nesting the attention button inside the workspace row ([47df47e](https://github.com/sero-labs/sero/commit/47df47ef1d1efda024bba40c2f978837147518fd))
* **docs:** migrate the docs site to Rspress v2 ([800a07a](https://github.com/sero-labs/sero/commit/800a07ae88078d5166dc58f4ff0edb3ea37142f2)), closes [#560](https://github.com/sero-labs/sero/issues/560)
* **memory:** stop the LLM session summary at shutdown ([2c4bf9d](https://github.com/sero-labs/sero/commit/2c4bf9db3f88c8058d90f0c37f5088e2ab276379))
* **orchestrator:** log GitHub poll failures once, with the reason ([46ecee8](https://github.com/sero-labs/sero/commit/46ecee82762c07a033343e7ebd01e2ae58dc4f2f))
* stabilize parallel tests and approval registration ([0a483a0](https://github.com/sero-labs/sero/commit/0a483a0ef15d93136d9e5b20d0ebb73fc0e7c3bc))
* **theme:** load selected preset in theme editor ([#528](https://github.com/sero-labs/sero/issues/528)) ([cf98c68](https://github.com/sero-labs/sero/commit/cf98c682683ff516fb206a35353b5b6c9df10ff8))
* **ui:** replace NativeSelect usages with themed Select ([#527](https://github.com/sero-labs/sero/issues/527)) ([2f2c4a5](https://github.com/sero-labs/sero/commit/2f2c4a5f15c7b00ba4ba236a7f141751b8cb088c)), closes [#321](https://github.com/sero-labs/sero/issues/321)
* ux improvements ([f430da5](https://github.com/sero-labs/sero/commit/f430da5c71260c3a5933abd271f773ac4c702c22))
* **worktree:** preserve checkouts when cleanup fails ([#478](https://github.com/sero-labs/sero/issues/478)) ([738fc41](https://github.com/sero-labs/sero/commit/738fc41712e98833d1f3a20141bc384f190aca1e))

### Performance

* **ci:** drop the dead Turbo cache wiring and cut the desktop suite cost ([#545](https://github.com/sero-labs/sero/issues/545)) ([#546](https://github.com/sero-labs/sero/issues/546)) ([fd826e9](https://github.com/sero-labs/sero/commit/fd826e92c2ec21982b98cc74b1e4551c40e03167))

### Documentation

* **architect:** add product screenshots ([8246427](https://github.com/sero-labs/sero/commit/82464277e696a1c1f185a2111f3d46e1db180ab0))
* **architect:** close tasks 8.2 and 8.4 with the gaps recorded ([ca987eb](https://github.com/sero-labs/sero/commit/ca987eb9d28ab0c61627a14734b9bf11f872f7e9))
* **architect:** document what the change made true ([f588294](https://github.com/sero-labs/sero/commit/f588294ccab80da9acc8b2a4afd0299877bdb654))
* **architect:** fix heading spacing in the change design ([9356cf6](https://github.com/sero-labs/sero/commit/9356cf639f7c4f5ab525f39cfcf3c92c378aaa70))
* **architect:** mark phase 2, phase 3 and task 4.1 complete in the change tasks ([d7a4e4d](https://github.com/sero-labs/sero/commit/d7a4e4d062611837439eeb37cf200beaf33ff5a6))
* **architect:** mark task 6.2 complete ([bf8654a](https://github.com/sero-labs/sero/commit/bf8654ad1a1dfee754096e3feb7fdca1c69ec979))
* **architect:** propose execution efficiency and observability ([d989bd2](https://github.com/sero-labs/sero/commit/d989bd20cb6b706e804d1aedb2786b70c1ed19f2))
* **guide:** improve Goal mode guide ([233f5aa](https://github.com/sero-labs/sero/commit/233f5aa0eb3c7354f59ebd1864075bce41f4de58))
* hand off the architect efficiency change ([4bdd422](https://github.com/sero-labs/sero/commit/4bdd4229f604c8eac80d933367903fec38bff971))

### Refactoring

* add disable-model-invocation to SKILL.md ([de86a1a](https://github.com/sero-labs/sero/commit/de86a1affcebf6c1180459ddb9753d43c7f35ee5))
* **architect:** resolve inspector React Doctor findings ([ce88053](https://github.com/sero-labs/sero/commit/ce88053915c246b665aabc673e360d08b7760611))
* split the six files this change pushed over 500 LOC ([1da2f52](https://github.com/sero-labs/sero/commit/1da2f5223a77143a9d513995eccc17580cd84e3e))
