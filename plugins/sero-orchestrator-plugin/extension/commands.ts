 ...
 *   /orchestrator activate|pause|resume|stop|run_next <loopId>
...
export function registerOrchestratorCommand(pi: ExtensionAPI): void {
  pi.registerCommand('orchestrator', {
    description: 'Manage Orchestrator loops: list, create, show, activate, pause, resume, stop, run_next, revise',
