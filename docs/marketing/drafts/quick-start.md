# Draft: 10-minute quick start

Status: DRAFT — copy for the README / docs-site, not yet published. All facts
below verified against the codebase and GitHub releases on 2026-07-06 (release
`v0.4.0-beta.0`). Re-verify release assets before publishing.
...
[run from source](https://docs.sero-ai.dev/guide/getting-started) with Node 22
and pnpm 10.
...
[Local LLMs with LM Studio](https://docs.sero-ai.dev/guide/local-llms-lm-studio).
...
- App won't open, or a provider shows unhealthy: see
  [Troubleshooting](https://docs.sero-ai.dev/reference/troubleshooting).
