...
- [`plugins/sero-google-plugin/`](./plugins/sero-google-plugin/plan.md)
  — *In progress — Phases 0–6 completed 2026-04-18, the Phase 7 code pass landed via `16c53ac`, and follow-up CLI summary polish landed via `e81bac9` + `6ddfb1e`; final host/container smoke plus in-app Gmail CSP revalidation still remain pending*
