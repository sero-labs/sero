...
- [`apps/desktop/`](./apps/desktop/plan.md)
  ...
  - [`apps/desktop/src/components/layout/`](./apps/desktop/src/components/layout/plan.md)
    — *In progress — shared git-remote workflow, WorkspaceTree split, ThemeEditorSheet split, ModelSelector split, ContextEditor split, and LocalProviderForm split items cleared 2026-04-15; remaining Medium cleanup pending*
