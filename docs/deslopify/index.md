...
- [`apps/desktop/`](./apps/desktop/plan.md)
  ...
  - [`apps/desktop/electron/features/auth/`](./apps/desktop/electron/features/auth/plan.md)
    — *In progress — High item plus GitHub device-flow Medium follow-up cleared 2026-04-15; GoogleAuthManager modularization and Low helper/guidance cleanup pending*
