...
- [`plugins/sero-google-plugin/`](./plugins/sero-google-plugin/plan.md)
  — *In progress — Phases 0–9 code/integration work plus the 2026-04-18 post-review hardening follow-up are landed; broader migration-level final verification still remains pending*
