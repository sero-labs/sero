...
- [`apps/desktop/`](./apps/desktop/plan.md)
  ...
  - [`apps/desktop/electron/features/vcs/`](./apps/desktop/electron/features/vcs/plan.md)
    — *In progress — High item plus filesystem checkpoint-source and shared-contract Medium fixes cleared 2026-04-16; remaining Medium transport/modularization cleanup pending*
