...
- [`plugins/sero-google-plugin/`](./plugins/sero-google-plugin/plan.md)
  — *In progress — Phases 0–9 code/integration work, the 2026-04-18 post-review hardening pass, and the final host cleanup of stale CLI/profile Google references are landed; broader migration-level final verification still remains pending*
