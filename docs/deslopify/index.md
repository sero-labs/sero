...
- [`plugins/sero-google-plugin/`](./plugins/sero-google-plugin/plan.md)
  — *In progress — Phases 0–6 completed 2026-04-18; the desktop shell no longer owns any Google-specific runtime surface, and only the plan’s final manual verification checklist remains pending*
