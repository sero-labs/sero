...
- [`apps/desktop/`](./apps/desktop/plan.md)
  ...
  - [`apps/desktop/electron/features/vcs/`](./apps/desktop/electron/features/vcs/plan.md)
    — *In progress — High item plus filesystem checkpoint-source Medium fix cleared 2026-04-16; remaining Medium contract/transport/modularization cleanup pending*
