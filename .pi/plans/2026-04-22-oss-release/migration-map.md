...
| `docs/superpowers/plans/**` | historical feature planning docs | transient with reusable facts | `docs/features/**`, `docs/architecture.md`, `docs/decisions.md` | remaining files still pending harvest + archive |
