...
| `docs/superpowers/plans/2026-04-06-merge-admin-resources.md` | transient with reusable facts | Large implementation plan with lots of concrete file/path details. | Archived on `private-archive/batch-d6-pre-prune-2026-04-24`; removed from this branch after harvest review. |
| `docs/superpowers/plans/2026-04-06-providers-panel.md` | transient with reusable facts | Large implementation plan; valuable as provenance, not a current doc. | Archived on `private-archive/batch-d7-pre-prune-2026-04-24`; removed from this branch after harvest review. |
