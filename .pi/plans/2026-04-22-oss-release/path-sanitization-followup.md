...
- `docs/superpowers/plans/2026-04-06-providers-panel.md` *(later archived on `private-archive/batch-d7-pre-prune-2026-04-24` and removed from this branch in Batch D step 7)*
