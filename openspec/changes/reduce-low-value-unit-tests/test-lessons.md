...
- Draft PR [#564](https://github.com/sero-labs/sero/pull/564) records accepted removals, false alarms, the stop decision, and validation. Leave it as a draft for the user's manual review before merge.
