...
- [Environment Doctor](/reference/environment-doctor) — built-in diagnostics launched from ⌘K → Diagnostics → Environment Doctor, `electron --doctor` safe mode, and the bundled `sero-doctor` CLI shim.
