...
| Design Library | `@sero-ai/plugin-design-library` | [Docs](/plugins/design-library) | Visual reference library with automatic design-language analysis, plus Sprite Studio for 2D sprite sheets; global state under the profile's Sero home. |
