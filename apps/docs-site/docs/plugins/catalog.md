...
| Design Library | `@sero-ai/plugin-design-library` | [Docs](/plugins/design-library) | Visual inspiration, AI design generation with live Tweaks, and an immutable Gallery; global app with a background runtime. |
