...
- [Web](/guide/web) explains web search, content fetching,
  bookmarks, provider prerequisites, and workspace-scoped web state.
- [Remote Control](/guide/remote-control) explains the optional, security-sensitive
...
- [Git Integration](/guide/git-integration) explains repository status, changes, branch
