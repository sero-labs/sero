...
vi.mock('../../kanban/live-output-bridge', () => ({
  bridgeSubagentLiveOutput: vi.fn(() => vi.fn()),
}));

vi.mock('../../kanban/verification', () => ({
...
vi.mock('../../kanban/light-review', () => ({
  shouldUseLightReview: vi.fn(() => false),
}));

vi.mock('../../kanban/light-review-workflow', () => ({
  runLightReviewWorkflow: vi.fn(),
}));

vi.mock('../../kanban/worktree-git', () => ({
...
import type { ReviewProgressTracker } from '../../kanban/review-progress';
