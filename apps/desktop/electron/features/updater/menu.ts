...
const viewMenu: MenuItemConstructorOptions = {
  ...
  submenu: [
    ...
    { accelerator: 'CommandOrControl+Shift+=', visible: false, acceleratorWorksWhenHidden: true, click: () => sendZoomCommand('in') },
    { accelerator: 'CommandOrControl+numadd', visible: false, acceleratorWorksWhenHidden: true, click: () => sendZoomCommand('in') },
    { accelerator: 'CommandOrControl+numsub', visible: false, acceleratorWorksWhenHidden: true, click: () => sendZoomCommand('out') },
    { type: 'separator' },
