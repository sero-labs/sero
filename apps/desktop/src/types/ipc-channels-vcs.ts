/**
 * VCS IPC channels — checkpoints, branches, remotes, pull requests and the
 * one named-action entry point (AD-025).
 *
 * Extracted from ipc-channels.ts to keep that file under 500 LOC.
 */
