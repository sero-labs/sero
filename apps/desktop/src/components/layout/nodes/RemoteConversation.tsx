...
export function RemoteConversation({ location }: { location: Extract<SessionLocation, { kind: 'node' }> }) {
  ...
  const { retry, setSessionApprovalMode, respondApproval } = useNodesStore.getState();
