  ...
  servers: [
    {
      ...
      cache: 'Fresh for 4 more min', transportLabel: 'Streamable HTTP',
    },
    {
    ...
    },
    {
      ...
      cache: 'Fresh for 7 more min', transportLabel: 'Streamable HTTP',
    },
    {
      name: 'reports', transport: 'HTTP', lifecycle: 'eager', auth: 'bearer', status: 'connected',
      revision: '2026-07-28', era: 'modern', extensions: ['Tasks'],
      cache: 'Stale, refreshed on next use', transportLabel: 'Streamable HTTP',
    },
    {
    ...
    },
    {
      ...
      cache: 'Cleared after the failed sign-in', transportLabel: 'Streamable HTTP',
    },
  ],

  tasks: [
    { id: 'tsk_7f3a', server: 'reports', tool: 'build_quarterly_report', status: 'working', age: '2 min', chat: 'Q3 report chat' },
    { id: 'tsk_51c0', server: 'reports', tool: 'export_ledger', status: 'completed', age: '1 h', chat: 'chat closed',
      result: 'Ledger export is ready: ledger-2026-09.csv (12,480 rows).' },
    { id: 'tsk_0b9e', server: 'sales', tool: 'refresh_forecast', status: 'disconnected', age: '8 min', chat: 'Forecast chat',
      note: 'Server not reachable. Sero retries in 30 s.' },
    { id: 'tsk_c2d4', server: 'sales', tool: 'sync_accounts', status: 'blocked', age: '3 h', chat: 'chat closed',
      note: 'Started by another account. Sign in as that account to continue.' },
    { id: 'tsk_9a11', server: 'reports', tool: 'archive_q2', status: 'expired', age: '2 d', chat: 'chat closed' },
  ],
    ...
    [
      { id: 'company', label: 'Company', prompt: 'Which company does Ana Ruiz work for?',
        options: [
          ...
          { value: 'decline', label: 'Decline', description: 'Send no answers to crm.' },
        ] },
